...
wire    [`PLIC_HART_NUM-1:0]  plic_hartx_mint_req;           
wire    [`PLIC_HART_NUM-1:0]  plic_hartx_sint_req;           
...
// Single-core configuration: core1 ct_top is intentionally not instantiated.
// Tie off the request/debug/status signals that were driven by core1.
// core1 ct_top removed for single-core configuration.

assign ibiu1_pad_acready        = 1'b0;
assign ibiu1_pad_araddr         = 40'b0;
assign ibiu1_pad_arbar          = 2'b0;
assign ibiu1_pad_arburst        = 2'b0;
assign ibiu1_pad_arcache        = 4'b0;
assign ibiu1_pad_ardomain       = 2'b0;
assign ibiu1_pad_arid           = 5'b0;
assign ibiu1_pad_arlen          = 2'b0;
assign ibiu1_pad_arlock         = 1'b0;
assign ibiu1_pad_arprot         = 3'b0;
assign ibiu1_pad_arsize         = 3'b0;
assign ibiu1_pad_arsnoop        = 4'b0;
assign ibiu1_pad_aruser         = 3'b0;
assign ibiu1_pad_arvalid        = 1'b0;
assign ibiu1_pad_awaddr         = 40'b0;
assign ibiu1_pad_awbar          = 2'b0;
assign ibiu1_pad_awburst        = 2'b0;
assign ibiu1_pad_awcache        = 4'b0;
assign ibiu1_pad_awdomain       = 2'b0;
assign ibiu1_pad_awid           = 5'b0;
assign ibiu1_pad_awlen          = 2'b0;
assign ibiu1_pad_awlock         = 1'b0;
assign ibiu1_pad_awprot         = 3'b0;
assign ibiu1_pad_awsize         = 3'b0;
assign ibiu1_pad_awsnoop        = 3'b0;
assign ibiu1_pad_awunique       = 1'b0;
assign ibiu1_pad_awuser         = 1'b0;
assign ibiu1_pad_awvalid        = 1'b0;
assign ibiu1_pad_back           = 1'b0;
assign ibiu1_pad_bready         = 1'b0;
assign ibiu1_pad_cddata         = 128'b0;
assign ibiu1_pad_cderr          = 1'b0;
assign ibiu1_pad_cdlast         = 1'b0;
assign ibiu1_pad_cdvalid        = 1'b0;
assign ibiu1_pad_cnt_en         = 4'b0;
assign ibiu1_pad_crresp         = 5'b0;
assign ibiu1_pad_crvalid        = 1'b0;
assign ibiu1_pad_csr_sel        = 1'b0;
assign ibiu1_pad_csr_wdata      = 80'b0;
assign ibiu1_pad_jdb_pm         = 1'b0;
assign ibiu1_pad_lpmd_b         = 1'b0;
assign ibiu1_pad_rack           = 1'b0;
assign ibiu1_pad_rready         = 1'b0;
assign ibiu1_pad_wdata          = 128'b0;
assign ibiu1_pad_werr           = 1'b0;
assign ibiu1_pad_wlast          = 1'b0;
assign ibiu1_pad_wns            = 1'b0;
assign ibiu1_pad_wstrb          = 16'b0;
assign ibiu1_pad_wvalid         = 1'b0;
assign pad_core1_dbg_mask       = 1'b1;
assign pad_core1_dbgrq_b        = 1'b1;
assign pad_core1_hartid         = 3'b0;
assign pad_core1_rst_b          = 1'b1;
assign pad_core1_rvba           = 40'b0;
assign core1_cpu_no_retire      = 1'b0;
assign core1_dbg_ack_pc         = 1'b0;
assign core1_enter_dbg_req_o    = 1'b0;
assign core1_exit_dbg_req_o     = 1'b0;
...
assign core1_regs_serial_data   = 64'b0;
...
assign plic_core1_me_int  = 1'b0;
assign plic_core1_se_int  = 1'b0;
//==========================================================
...
ct_sysio_top  x_ct_sysio_top (
  ...
  .clint_core0_ss_int         (clint_core0_ss_int        ),
  .clint_core0_st_int         (clint_core0_st_int        ),
  .clint_core1_ms_int         (1'b0                      ),
  .clint_core1_mt_int         (1'b0                      ),
  .clint_core1_ss_int         (1'b0                      ),
  .clint_core1_st_int         (1'b0                      ),
